        ...
        <div className="glass-dark overflow-hidden rounded-[2rem] p-8 sm:p-12">
          <div className="grid gap-8 md:grid-cols-[1.5fr_1fr]">
            ...
            <div className="md:text-right">
              ...
              <p className="mt-2 text-[0.78rem] leading-relaxed text-cream/90">{COURSE.credentials}</p>
          ...
          <div className="mt-9 flex flex-col items-center justify-between gap-3 border-t border-cream/10 pt-6 text-xs text-cream/80 sm:flex-row">
